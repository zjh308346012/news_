  ...
  <div class="editWrapper">
    ...
    <div class="fileImage">
      ...
      <img
        ...
        v-cloak
        class="avatar"
        :src="'http://127.0.0.1:3000' + list.head_img"
        alt=""
      />
    ...
    <Authnew
      labelText="昵称"
      :descText="list.nickname"
      @click.native="isNickname = true"
    />
    ...
    <Authnew
      labelText="性别"
      :descText="['女', '男'][list.gender]"
      @click.native="isGender = true"
    />
...
export default {
  ...
  methods: {
    ...
    afterRead(file) {
      ...
      //创建一个formData的实例对象 因为上传文件是要用表单上传

      formData.append('file',file.file)
      //将文件加进这个实例对象 ,然后文件上传的axios的API 上传文件,这里只是上传到服务器 但是并没有预览的功能
